...
import { useNote } from "./ShowMarkdown";
...
function EditMarkdown({ onSubmit, onAddTag, availableTags }: EditMarkdownProps) {
  ...
  return (
    <div>
      <h3 className="my-4">Edit File</h3>
      <Form onSubmit={handleSubmit}>
        <Stack gap={4}>
          ...
          <Form.Group controlId="markdown">
            ...
            <Form.Control ref={bodyRef} required as="textarea" defaultValue={note.text} style={{ minHeight: '25rem' }}/>
          </Form.Group>
        </Stack>
        <Stack direction="horizontal" gap={2} className="justify-content-end mt-3">
          <Button type="submit" variant="success" className="marginRight: 3">Save</Button>
